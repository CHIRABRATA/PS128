...
export default function VetError({
  ...
  useEffect(() => {
    console.error("[Veterinarian Portal Error]:", error);
  }, [error]);
    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6 min-h-[60vh] max-w-md mx-auto text-center space-y-5 text-[#191F1C]">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-stone-600 leading-relaxed">
          Unable to retrieve clinical cases or update veterinary records. Please refresh your triage session.
        </p>
        {error.message && (
