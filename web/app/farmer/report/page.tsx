  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 max-w-4xl mx-auto w-full gap-6 bg-[#FAF8F3] text-[#191F1C]">
      <div className="flex items-center justify-between border-b border-[#E5E0D8] pb-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#191F1C] tracking-tight">Report Livestock Illness</h1>
          <p className="text-xs text-stone-500 mt-0.5">
            Record animal symptoms for automated triage, AI decision support, and veterinary consultation.
          </p>
        </div>
