  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-4">
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        >
          <div
            className={`p-6 rounded-2xl border transition-all duration-300 ${
              hoveredRole === "farmer"
                ? "border-emerald-600 bg-white shadow-md -translate-y-1"
        ...
        >
          <div
            className={`p-6 rounded-2xl border transition-all duration-300 ${
              hoveredRole === "agent"
                ? "border-amber-600 bg-white shadow-md -translate-y-1"
      ...
      <div className="lg:col-span-4 flex flex-col items-center justify-center relative">
        <div className="relative w-full aspect-square max-w-[320px] rounded-3xl overflow-hidden border-2 border-[#E5E0D8] shadow-md bg-stone-100 group transition-all duration-500 hover:shadow-xl hover:border-emerald-600">
          <Image
        ...
        <div className={`mt-3 px-3 py-1 rounded-full text-xs font-medium border transition-all duration-300 ${
          hoveredRole
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        >
          <div
            className={`p-6 rounded-2xl border transition-all duration-300 ${
              hoveredRole === "vet"
                ? "border-blue-600 bg-white shadow-md -translate-y-1"
          ...
          <div
            className={`p-6 rounded-2xl border transition-all duration-300 ${
              hoveredRole === "authority"
                ? "border-purple-600 bg-white shadow-md -translate-y-1"
