    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <label className="text-xs font-bold text-stone-700 uppercase tracking-wider flex items-center gap-1.5">
          ...
          <span>IoT सेन्सर व शारीरिक तापमान | IoT Vitals (Optional)</span>
        </label>
        {linkedIotDeviceId ? (
          ...
          <span className="text-[11px] text-stone-500">ऐच्छिक</span>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 rounded-2xl border border-[#E5E0D8] bg-[#FAF8F3] shadow-2xs">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            type="number"
            step="0.1"
            placeholder="उदा. 38.5 किंवा 40.1"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="act" className="text-xs text-stone-700 font-bold flex items-center gap-1">
            ...
            <span>हालचाल निर्देशांक (Activity)</span>
          </Label>
          <Input
            id="act"
            type="number"
            placeholder="उदा. 22 (कमी) ते 85"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="hr" className="text-xs text-stone-700 font-bold flex items-center gap-1">
            ...
            <span>हृदय गती (BPM)</span>
          </Label>
          <Input
            id="hr"
            type="number"
            placeholder="उदा. 60 - 95"
